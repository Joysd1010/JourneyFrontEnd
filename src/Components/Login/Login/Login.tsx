          ...
          <div className="flex flex-col gap-2 px-10 py-5 border-2 border-blue-500 w-96 rounded-xl">
            ...
            >
              ...
              <input
                ...
                className="w-full max-w-xs shadow-lg duration-700 hover:shadow-[#5572e6] shadow-[#7289dd] border-blue-600 input input-bordered"
              ...
              <input
                ...
                className="w-full max-w-xs shadow-lg duration-700 hover:shadow-[#5572e6] shadow-[#7474dd] border-blue-600 input input-bordered "
              ...
              <input
                ...
                type="submit"
                value="Login"
                className="w-full max-w-xs my-5 duration-1000 shadow-lg hover:shadow-[#5572e6] shadow-[#7f74dd] bg-[#8d79f3] hover:bg-blue-400 input input-bordered btn"
              />{" "}
            </form>
