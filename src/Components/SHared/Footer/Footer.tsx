    ...
    <div className="  bg-[#E6E6FA]">
      <div className="px-3 md:px-10 py-2 items-start grid gap-3 md:grid-cols-3 ">
        ...
        <div className=" w-64 md:w-96">
          ...
          <div>
          We are everywhere to serve you all service that you need in home 
          </div>
        ...
        <div className=" md: pt-5">
          ...
          <div className="text-base flex flex-col gap-3 text-pink-900">
            ...
            <NavLink className={`hover:translate-x-2 duration-300`} to={"toy"}>Book a Service </NavLink>
            <NavLink className={`hover:translate-x-2 duration-300`} to={"contact"}>Register as worker </NavLink>
          </div>
        </div>
        {/* ----------------Contact us part of the footer------------------- */}
        <div className="flex flex-col gap-3 md:pt-5"> 
        <h1 className=" text-2xl font-semibold">GET IN TOUCH</h1>
          <div className=" flex items-center gap-2"><BiLogoGmail  size={25}/>info@newarea.com</div>
      ...
      <h1 className=" text-center text-sm py-2 text-white bg-[#090606]">
